  ...
  return (
    <section className="overflow-x-hidden w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32 flex flex-col lg:flex-row items-center gap-16 relative">
      ...
      <div className="flex-1 text-center lg:text-left z-10">
        ...
        >
          Experience a sophisticated healthcare consultant available 24/7. From
          specialized inquiries to live audio consultations, Vora AI delivers
          precise and empathetic guidance.
        </motion.p>
        ...
        >
          <Link
            href="/chat"
            className="h-14 px-8 rounded-full bg-slate-900 text-white flex items-center gap-2 font-medium hover:bg-slate-800 transition-colors shadow-lg shadow-slate-900/20 active:scale-95 w-full sm:w-auto justify-center"
          >
            Start Text Consult
          </Link>
          <Link
            href="/consult"
            className="h-14 px-8 rounded-full bg-red-600 text-white flex items-center gap-2 font-medium hover:bg-red-700 transition-colors shadow-lg shadow-red-600/20 active:scale-95 w-full sm:w-auto justify-center"
          >
            Live Audio Session
            <ArrowRight size={20} />
          </Link>
          ...
          <div className="relative z-20 space-y-3 sm:space-y-4 w-full">
            ...
            >
              <p className="text-slate-800 text-xs leading-relaxed font-medium">
                I have analyzed your medical history. The recent variations
                align with restorative protocols.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="font-medium relative z-10 text-xs leading-snug">
                Please describe your symptoms and how you are feeling today.
              </p>
            </motion.div>
          </div>
        </div>
