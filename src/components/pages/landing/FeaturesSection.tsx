      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-display font-bold text-slate-900 mb-4">
            Sophisticated Care Intelligence
          </h2>
          <p className="text-slate-500 max-w-2xl mx-auto">
            Equipped with state-of-the-art AI architecture, Vora understands
            complex medical contexts up to thousands of pages.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: "Upload lab results, images, and documents for a comprehensive health overview.",
            },
            {
              icon: Clock,
              title: "Real-time Live Audio",
              desc: "Converse naturally with Vora through cutting-edge, ultra-low latency voice models.",
            },
            {
              icon: Shield,
              title: "Secure & Private",
              desc: "Your consultation history is securely stored on your device via IndexedDB.",
            },
          ].map((f, i) => (
            <div
              key={i}
