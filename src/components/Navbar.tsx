        ...
        <nav className="flex items-center gap-1 sm:gap-4">
          ...
          >
            <MessageSquare
              ...
              className={cn(
                "transition-colors",
                pathname === "/chat" ? "text-slate-900" : "text-slate-400",
              )}
            />
          ...
          <Link
            ...
            className={cn(
              "flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium transition-all duration-300",
              pathname === "/consult"
                ? "bg-red-600 text-white shadow-lg shadow-red-600/25 border-t border-white/20 scale-105"
                : "bg-white text-slate-600 border border-slate-200 hover:border-red-200 hover:text-red-600 hover:bg-red-50 hover:shadow-sm",
            )}
          >
            <Mic
              size={18}
